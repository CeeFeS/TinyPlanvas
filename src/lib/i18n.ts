...
export const translations = {
  ...
  header: {
    ...
    toggleLanguage: { de: 'Sprache umschalten', en: 'Switch language' },
  },
  ...
  customColumns: {
    ...
    viewOnlyHint: { de: 'Nur-Lesen-Ansicht', en: 'View-only' },
  },
  ...
  brush: {
    ...
    customValues: { de: 'Prozentwerte', en: 'Percentage values' },
    addCustomValue: { de: 'Wert hinzufügen', en: 'Add value' },
    removeCustomValue: { de: 'Wert entfernen', en: 'Remove value' },
    intensityScale: { de: 'Intensitäts-Skala', en: 'Intensity Scale' },
    activeBrush: { de: 'Aktiver Pinsel', en: 'Active Brush' },
    settingsTooltip: { de: 'Farbe & Prozentwerte verwalten', en: 'Manage color & percentages' },
    editPercentage: { de: 'Prozentwert bearbeiten', en: 'Edit percentage' },
    editPercentageHint: { de: 'Nochmals klicken zum Bearbeiten · Enter setzen · Shift+Enter als Preset', en: 'Click again to edit · Enter to apply · Shift+Enter as preset' },
    shortcutHint: { de: 'Taste {n}', en: 'Key {n}' },
    keyboardHints: { de: '1–9 und 0 = Presets in Reihenfolge · [ / ] · Scroll', en: '1–9 and 0 = presets in order · [ / ] · scroll' },
    presetsCount: { de: '{count}/{max}', en: '{count}/{max}' },
    keepOne: { de: 'Mindestens ein Wert muss bleiben', en: 'At least one value must remain' },
  },
  ...
  share: {
    ...
    tabUsers: { de: 'Benutzer', en: 'Users' },
    tabLink: { de: 'Öffentlicher Link', en: 'Public link' },
    linkDescription: {
      de: 'Erzeuge einen sicheren Link, mit dem jede Person das Projekt nur ansehen kann — ohne Login.',
      en: 'Create a secure link that lets anyone view this project without logging in.',
    },
    publicLink: { de: 'Öffentlicher Ansichtslink', en: 'Public view link' },
    linkActive: { de: 'Link ist aktiv (nur Lesen)', en: 'Link is active (view only)' },
    linkInactive: { de: 'Kein öffentlicher Link aktiv', en: 'No public link active' },
    enableLink: { de: 'Link aktivieren', en: 'Enable link' },
    disableLink: { de: 'Link deaktivieren', en: 'Disable link' },
    copyLink: { de: 'Kopieren', en: 'Copy' },
    copied: { de: 'Kopiert', en: 'Copied' },
    regenerateLink: { de: 'Neuen Link erzeugen', en: 'Regenerate link' },
    regenerateConfirm: {
      de: 'Alten Link ungültig machen und einen neuen erzeugen?',
      en: 'Invalidate the old link and create a new one?',
    },
    linkHint: {
      de: 'Der Link ist lang und schwer zu erraten. Wer ihn hat, kann das Projekt nur lesen.',
      en: 'The link is long and hard to guess. Anyone with it can view the project read-only.',
    },
    linkError: { de: 'Fehler beim Aktualisieren des Links', en: 'Failed to update share link' },
    copyError: { de: 'Kopieren fehlgeschlagen', en: 'Failed to copy' },
    sharedViewBanner: { de: 'Geteilte Ansicht (nur Lesen)', en: 'Shared view (read only)' },
    sharedLoadError: { de: 'Dieser Share-Link ist ungültig oder wurde deaktiviert.', en: 'This share link is invalid or has been disabled.' },
  },
